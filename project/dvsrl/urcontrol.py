...
moves.append("movep(p[1.0, -0.16, 0, 0.5, 3, 0.015], a=1.3962634015954636, v=0.1071975511965976, r=0.2)\n")
s.send(moves[0])
time.sleep(3)
s.send("movep(p[1.3, -0.16, 0, 0.5, 3, 0.015], a=1.3962634015954636, v=0.1071975511965976, r=0.2)\n")
time.sleep(0.5)
s.send("movep(p[1.1, 0.2, 0, 0.5, 3, 0.015], a=1.3962634015954636, v=0.1071975511965976, r=0.2)\n")
'''
